...
export const getServerSideProps = async () => {
  ...
  const payload =
    ...
    select s3.url as image_url, swing_prediction.prediction_url as prediction_image_url from s3 inner join swing_prediction on s3."swingId" = swing_prediction.swing_id`;
  console.log(payload.rows, "payload");
  return {
    props: {
      swingImages: payload.rows || [],
    },
  };
};
